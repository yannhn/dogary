...
`;function AddButton(_ref){let{buttonText,cancelForm}=_ref;return(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:(0,jsx_runtime.jsx)(StyledAddButton,{onClick:cancelForm,children:buttonText})})}const StyledCancelButton=styled_components_browser_esm.ZP.button`
	padding: 0.5em 1em;
	border: none;
	border-radius: 5px;
	background: #c3423f;
...
`,InputGoalButtonGroup=styled_components_browser_esm.ZP.section`
	...
	justify-content: space-evenly;
	margin: 2em 0 1em;
`;function InputGoalForm(_ref){let{cancelForm,onCancelGoalForm}=_ref;const[amount,setAmount]=(0,react.useState)(0);return(0,jsx_runtime.jsxs)(GoalForm,{onSubmit:event=>{event.preventDefault();const newAmount={amount};console.log(newAmount),setAmount(0)},children:[(0,jsx_runtime.jsx)(InputGoalHeader,{children:"How much food should your dog eat today?"}),(0,jsx_runtime.jsxs)(InputGoalSection,{children:[(0,jsx_runtime.jsx)(InputGoalLabel,{htmlFor:"enterAmount",children:"Input your goal amount in gram"}),(0,jsx_runtime.jsx)(InputGoalAmount,{id:"enterAmount",type:"number",value:amount,min:"0",onChange:event=>setAmount(event.target.value)})]}),(0,jsx_runtime.jsxs)(InputGoalButtonGroup,{children:[(0,jsx_runtime.jsx)("button",{type:"button",onCancelGoalForm,children:"Get back"}),(0,jsx_runtime.jsx)("button",{type:"button",onCancelGoalForm,children:"Get back"}),(0,jsx_runtime.jsx)(CancelButton,{type:"button",buttonText:"Cancel",cancelForm}),(0,jsx_runtime.jsx)(AddButton,{type:"submit",buttonText:"Add food goal",onClick:cancelForm})]})]})}const FoodCardContainer=styled_components_browser_esm.ZP.section`
	margin: 2em;
	padding: 1em 1em;
	border: none;
	border-radius: 5px;
...
//# sourceMappingURL=main.3c2370e7.iframe.bundle.js.map