...
`;function InputFood(_ref){let{addNewFoodItem,cancelForm}=_ref;const[enteredAmount,setEnteredAmount]=(0,react.useState)(0),[enteredTime,setEnteredTime]=(0,react.useState)("08:00");return(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{children:(0,jsx_runtime.jsx)(InputFoodContainer,{children:(0,jsx_runtime.jsxs)("form",{onSubmit:event=>{event.preventDefault();const newFoodInput={id:(0,index_browser.x0)(),amount:parseInt(enteredAmount),time:enteredTime};addNewFoodItem(newFoodInput),setEnteredAmount(0),setEnteredTime("")},children:[(0,jsx_runtime.jsx)("h4",{children:"Your dog"}),(0,jsx_runtime.jsx)("section",{children:(0,jsx_runtime.jsxs)("label",{children:["How many gram did the dog eat",(0,jsx_runtime.jsx)("input",{type:"number",min:"0",value:enteredAmount,onChange:event=>setEnteredAmount(event.target.value)})]})}),(0,jsx_runtime.jsx)("section",{children:(0,jsx_runtime.jsxs)("label",{children:["When did the dog eat",(0,jsx_runtime.jsx)("input",{type:"time",value:enteredTime,onChange:event=>setEnteredTime(event.target.value)})]})}),(0,jsx_runtime.jsxs)("section",{children:[(0,jsx_runtime.jsx)("button",{type:"submit",children:"Add"}),(0,jsx_runtime.jsx)("button",{type:"button",onClick:cancelForm,children:"cancel"})]})]})})})}var unit=__webpack_require__("./src/utils/unit.js");const FoodCardContainer=styled_components_browser_esm.ZP.section`
	margin: 2em;
	padding: 0.2em 1em;
	border: 1px solid black;
	border-radius: 10px;
...
//# sourceMappingURL=main.27de3eae.iframe.bundle.js.map